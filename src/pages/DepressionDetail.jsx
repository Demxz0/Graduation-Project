        ...
        <FadeSection>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(280px,1fr))", gap: 16 }}>
                {[
                    ...
                    { title: "اضطراب الاكتئاب", color: "#9a0000", text: "حالة طبية تُؤثر على الدماغ وتُغير كيمياءه وبنيته. يستمر لأسابيع أو أشهر أو سنوات ويعطل الحياة اليومية. — لا يمكن 'التغلب عليها بالإرادة' لأنها بيولوجية في جوهرها." },
...
const TYPES = [
    ...
    { n: "٣", en: "DMDD", ar: "خلل تنظيم المزاج التخريبي", color: "#2a6275", pts: ["نوبات غضب شديدة ومتكررة عند الأطفال والمراهقين، تفوق كثيراً ما يستدعيه الموقف.", "المزاج العام في ما بين النوبات يكون حزيناً أو غاضباً أغلب الوقت.", "يؤثر على الأداء في المدرسة والعلاقات الأسرية ويختلف عن ثنائي القطب الذي لا يُشخَّص لمن دون 18 عاماً."] },
    { n: "٤", en: "PMDD", ar: "اضطراب ما قبل الدورة الشهرية", color: "#7571b8", pts: ["اكتئاب وقلق شديد يظهر قبل الدورة الشهرية بأسبوع إلى أسبوعين ويختفي بعد بدئها.", "تغيرات مزاجية حادة، تعب، اضطرابات نوم أو شهية، شعور بفقدان السيطرة.", "أشد بكثير من متلازمة ما قبل الدورة (PMS) العادية — يُعطل الحياة اليومية بشكل كبير."] },
...
const TRAITS = [
    ...
    { ar: "الاعتمادية العاطفية", en: "Emotional Dependency", desc: "الحاجة المفرطة للأهتمام من الأخرين للشعور بأن الحياة تستحق أو أن الفرد محبوب." },
...
const BRAIN_STEPS = [
    ...
    { n: "٦", label: "NEUROTRANSMITTERS · النواقل العصبية", color: COLORS.coral, text: "انخفاض في السيروتونين يُؤثر على النوم والمزاج — وانخفاض النورإبينفرين يُسبب الإرهاق وبطء التفكير." },
];
...
const TREATMENTS = [
    ...
    { icon: "✨", en: "Other Therapies", title: "٣. العلاج المدمج", color: "#9a0000", badge: "الأفضل ", pts: [["", "دمج CBT مع الأدوية يُعطي أفضل النتائج وأقل معدلات انتكاس — الأدوية تُخفف الأعراض بما يُمكّن المريض من الاستفادة من الجلسات."]] },
...
export default function DepressionDetail() {
    useEffect(() => {
        ...
        style.textContent = `@keyframes fadeIn { from { opacity:0 } to { opacity:1 } } ::-webkit-scrollbar { width:6px } ::-webkit-scrollbar-thumb { background:#9a0000; border-radius:10px }`;
