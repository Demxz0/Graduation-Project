...
function Hero() {
    ...
    return (
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", padding: "8rem 1.5rem 6.5rem", position: "relative", overflow: "hidden", background: "#ffd8bf" }}>
...
function Definition() {
    return (
        <FadeSection>
            ...
            <h2 style={s.h2}><span style={{ color: "#493054" }}>ما هو </span><span style={{ color: COLORS.coral }}>القلق؟</span></h2>
...
function Types() {
    ...
    return (
        <FadeSection>
            ...
            <h2 style={s.h2}><span style={{ color: "#493054" }}>أنواع </span><span style={{ color: COLORS.coral }}>الاضطراب</span><span style={{ color: "#493054" }}> وأشكاله</span></h2>
...
function Symptoms() {
    ...
    return (
        <FadeSection>
            ...
            <h2 style={s.h2}><span style={{ color: "#493054" }}>كيف يظهر </span><span style={{ color: COLORS.coral }}>القلق</span><span style={{ color: "#493054" }}> في جسدك؟</span></h2>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(240px,1fr))", gap: 10 }}>
                    {cur.items.map((item, i) => (
                        <div key={i}
                            ...
                            style={{ ...s.card, display: "flex", alignItems: "center", gap: 12, fontSize: "0.9rem", color: "#552269", fontWeight: "bold", boxShadow: "0 4px 12px rgba(0,0,0,0.05)" }}>
...
function Causes() {
    return (
        <FadeSection>
            ...
            <h2 style={s.h2}><span style={{ color: "#493054" }}>من أين يأتي </span><span style={{ color: COLORS.coral }}>القلق؟</span></h2>
...
function Maladaptive() {
    return (
        <FadeSection>
            ...
            <h2 style={s.h2}><span style={{ color: "#493054" }}>حين تُخطئ </span><span style={{ color: COLORS.coral }}>طريقة التعامل</span></h2>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(260px,1fr))", gap: 12 }}>
                {MALAD.map((m, i) => (
                    <div key={i} 
                        ...
                        onMouseLeave={e => { e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "none"; }}
                        style={{ ...s.card, gridColumn: m.wide ? "1 / -1" : undefined, paddingTop: "1rem" }}>
...
function Personality() {
    return (
        <FadeSection>
            ...
            <h2 style={s.h2}><span style={{ color: "#493054" }}>القلق </span><span style={{ color: COLORS.coral }}>يُغيّر</span><span style={{ color: "#493054" }}> شخصيتك</span></h2>
...
function BrainStep({ step, index }) {
    ...
    return (
        <div ref={ref} style={{ display: "grid", gridTemplateColumns: "60px 1fr", gap: 16, opacity: visible ? 1 : 0, transform: visible ? "translateX(0)" : "translateX(20px)", transition: `opacity 0.5s ${index * 0.12}s ease, transform 0.5s ${index * 0.12}s ease` }}>
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                <div style={{ width: 52, height: 52, borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Tajawal', sans-serif", fontWeight: 900, fontSize: "1.1rem", color: "#100217", border: "2px solid #e4b495", background: "#e4b495", flexShrink: 0 }}>{step.n}</div>
                {index < BRAIN_STEPS.length - 1 && <div style={{ width: 1, height: 32, background: "linear-gradient(to bottom, #e4b495, transparent)", margin: "4px 0" }} />}
            </div>
            <div style={{ ...s.card, marginBottom: 12, borderColor: "#e4b495" }}>
    ...
    return (
        <FadeSection>
            <span style={s.label}>علم الأعصاب</span>
                  <h2 style={s.h2}><span style={{ color: "#493054" }}>رحلة داخل </span><span style={{ color: "#E67E22" }}>دماغك</span></h2>
...
function Treatment() {
    ...
    return (
        <FadeSection>
            ...
            <h2 style={s.h2}><span style={{ color: "#493054" }}>طريقك نحو </span><span style={{ color: "#d6936a" }}>التعافي</span></h2>
