...
const examData = {
  ...
  anxiety: {
    ...
    questions: [
      ...
      'هل عانيت من نوبات مفاجئة وغير متوقعة من الخوف الشديد مصحوبة بأعراض جسدية (تسارع النبض، تعرق، ضيق تنفس)؟',
  ...
  adhd: {
    ...
    questions: [
      'هل تجد صعوبة في إنهاء التفاصيل النهائية للمشروع بمجرد الانتهاء من الأجزاء الصعبة؟',
      'هل تجد صعوبة في ترتيب الأشياء وتنظيمها عندما تضطر للقيام بمهمة تتطلب التنظيم؟',
      'هل تواجه مشكلة في تذكر المواعيد أو الالتزامات؟',
      'عندما يكون لديك مهمة تتطلب الكثير من التفكير، هل تتجنب أو تؤجل البدء فيها؟',
      'هل تحرك يديك أو قدميك بتململ عندما تضطر للجلوس لفترة طويلة؟',
      'هل تشعر بأنك مدفوع ومنطلق وكأنك "محرك" ولا تستطيع التوقف عن النشاط؟',
      'هل ترتكب أخطاء بسبب عدم الانتباه عند العمل على مشروع ممل أو متكرر؟',
      'هل تجد صعوبة في التركيز على ما يقوله الناس لك، حتى عندما يتحدثون إليك مباشرة؟',
      'هل تضيع أو تواجه صعوبة في العثور على أشيائك الضرورية (مفاتيح، محفظة، هاتف)؟',
      'هل تقاطع الآخرين في حديثهم أو تنهي جملهم قبل أن يكملوا كلامهم؟',
    ],
    results: [
      {
        range: [0, 7],
  ...
  eating: {
    ...
    questions: [
      ...
      'هل تلجأ لسلوكيات غير صحية بعد الأكل (مثل التقيؤ العمد أو الإفراط في التمارين)؟',
